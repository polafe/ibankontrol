...
#pip kurulumu chromedriver-binary
...
for i in range(1, sheet.max_row):
    ...
    #yazma
    driver.find_element("id", "ibangir").clear()
    driver.find_element("id", "ibangir").send_keys(deger.value)
    driver.find_element("xpath", "/html/body/div[1]/section/div[8]/form/div/div/button").click()
    sonuc = driver.find_element("xpath", "/html/body/div[1]/section/div[8]/div[1]/p[2]").text
